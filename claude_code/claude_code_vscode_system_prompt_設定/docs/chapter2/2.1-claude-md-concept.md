...
> **💡 重要提示:** CLAUDE.md 同時支援 **VSCode 擴充套件** 和 **CLI 工具**。CLI 工具還支援全域 CLAUDE.md (`~/.claude/CLAUDE.md`),可為所有專案設定預設值。詳見 [2.4 VSCode vs CLI 差異](./2.4-vscode-vs-cli.md)
...
| 功能 | VSCode 擴充套件 | CLI 工具 |
|:-----|:---------------|:---------|
| 專案 CLAUDE.md | ✅ 支援 | ✅ 支援 |
| 資料夾 CLAUDE.md | ✅ 支援 | ✅ 支援 |
| 全域 CLAUDE.md | ❌ 不支援 | ✅ `~/.claude/CLAUDE.md` |

**詳細差異請參考:** [2.4 VSCode vs CLI 差異](./2.4-vscode-vs-cli.md)
...
- [2.4 VSCode vs CLI 差異](./2.4-vscode-vs-cli.md) - 兩種工具的完整對比
